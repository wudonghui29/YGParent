...
@interface deviceTrackViewController ()<FSCalendarDelegate, HourPickerDlegate>{
...
@implementation deviceTrackViewController

#pragma mark - life cyle 
- (void)dealloc{
    NSLog(@"deviceTrackViewController dealloc");
}
...
- (void)viewDidLoad {
    ...
    UIView *b = [[UIView alloc] initWithFrame:CGRectMake(0, 54, kScreenWidth, kScreenHeight-54)];
